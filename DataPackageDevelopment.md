...
handle dataset assets submitted to IM (metadata templates, datafiles, etc). The completed ezEML packages are downloaded (as zip) to this location, for subsequent upload to the EDI staging and production servers.
